...
const page = () => {
  ...
  <Link href="/ServiceproviderUP"><button className="bg-gray-200 text-black hover:bg-blue-500 hover:text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mx-1">
    Edit Profile
  </button></Link>
