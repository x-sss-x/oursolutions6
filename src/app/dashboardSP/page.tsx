...
var Page = () => {
  return (
    <div>
      ...
      <div className="container mx-auto p-4 w-full h-96 border-2 border-sky-500 bg-stone-200 p-4 my-2 rounded-xl ">
      ...
      <div className="container mx-auto p-4 w-full h-96 border-2 border-sky-500 bg-stone-200 p-4 my-2 rounded-xl mt-5">
