      ...
      <form className="grid grid-cols-2 gap-6 max-w-md bg-white rounded px-2 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
        <div>
          <input
            ...
            id="email"
            type="email"
            placeholder="Serviceprovider_email"
            value={email}
        ...
        <div>
          <input
            ...
            id="username"
            type="text"
            placeholder="Serviceprovider_name"
            value={username}
        ...
        <div>
          <input
            ...
            id="phoneNumber"
            type="text"
            placeholder="Serviceprovider_no"
            value={phoneNumber}
        ...
        <div>
          <input
            ...
            id="age"
            type="text"
            placeholder="Serviceprovider_age"
            value={age}
        ...
        <div>
          <input
            ...
            id="address"
            type="text"
            placeholder="Serviceprovider_address"
            value={address}
